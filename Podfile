...
target 'MSPDemoApp' do
  project 'MSPDemoApp/MSPDemoApp'
  #use_frameworks!
  pod 'MSPCore', '4.5.0', :modular_headers => true
  pod 'MSPNovaAdapter', '4.5.0', :modular_headers => true
  pod 'MSPGoogleAdapter', '4.5.0', :modular_headers => true
  pod 'MSPFacebookAdapter', '4.5.0', :modular_headers => true
