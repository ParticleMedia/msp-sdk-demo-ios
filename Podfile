...
target 'MSPDemoApp' do
  project 'MSPDemoApp/MSPDemoApp'
  #use_frameworks!
  pod 'MSPCore', '2.6.0', :modular_headers => true
  pod 'NovaAdapter', '2.6.0', :modular_headers => true
  pod 'GoogleAdapter', '2.6.0', :modular_headers => true
  pod 'FacebookAdapter', '2.6.0', :modular_headers => true
