...
target 'MSPDemoApp' do
  project 'MSPDemoApp/MSPDemoApp'
  #use_frameworks!
  pod 'MSPCore', '3.4.0', :modular_headers => true
  pod 'MSPNovaAdapter', '3.4.0', :modular_headers => true
  pod 'MSPGoogleAdapter', '3.4.0', :modular_headers => true
  pod 'MSPFacebookAdapter', '3.4.0', :modular_headers => true
