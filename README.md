...
```
pod 'MSPCore', '3.4.3', :modular_headers => true
# if you want Nova Ads 
pod 'MSPNovaAdapter', '3.4.3', :modular_headers => true
# if you want Google Ads
pod 'MSPGoogleAdapter', '3.4.3', :modular_headers => true
# if you want Facebook Ads
pod 'MSPFacebookAdapter', '3.4.3', :modular_headers => true
```
