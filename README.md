...
```
pod 'MSPCore', '2.1.0', :modular_headers => true
# if you want Nova Ads 
pod 'NovaAdapter', '2.1.0', :modular_headers => true
# if you want Google Ads
pod 'GoogleAdapter', '2.1.0', :modular_headers => true
# if you want Facebook Ads
pod 'FacebookAdapter', '2.1.0', :modular_headers => true
```
