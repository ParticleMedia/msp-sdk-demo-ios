...
struct Com_Newsbreak_Mes_Events_GetAdEvent: @unchecked Sendable {
...
extension Com_Newsbreak_Mes_Events_GetAdEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetAdEvent"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    9: .standard(proto: "error_code"),
    10: .standard(proto: "error_message"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 9: try { try decoder.decodeSingularEnumField(value: &_storage._errorCode) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._errorCode != .unspecified {
        try visitor.visitSingularEnumField(value: _storage._errorCode, fieldNumber: 9)
      }
  ...
  static func ==(lhs: Com_Newsbreak_Mes_Events_GetAdEvent, rhs: Com_Newsbreak_Mes_Events_GetAdEvent) -> Bool {
