...
struct Com_Newsbreak_Mes_Events_AdClickEvent: @unchecked Sendable {
...
extension Com_Newsbreak_Mes_Events_AdClickEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AdClickEvent"
  ...
  static func ==(lhs: Com_Newsbreak_Mes_Events_AdClickEvent, rhs: Com_Newsbreak_Mes_Events_AdClickEvent) -> Bool {
