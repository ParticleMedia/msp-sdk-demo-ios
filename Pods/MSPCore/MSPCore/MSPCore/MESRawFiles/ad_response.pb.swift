...
struct Com_Newsbreak_Mes_Events_AdResponse: @unchecked Sendable {
...
extension Com_Newsbreak_Mes_Events_AdResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Com_Newsbreak_Mes_Events_AdResponse, rhs: Com_Newsbreak_Mes_Events_AdResponse) -> Bool {
