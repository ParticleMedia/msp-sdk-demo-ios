...
struct Com_Newsbreak_Mes_Events_AdHideEvent: @unchecked Sendable {
...
extension Com_Newsbreak_Mes_Events_AdHideEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AdHideEvent"
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._os != .unspecified {
        try visitor.visitSingularEnumField(value: _storage._os, fieldNumber: 5)
      }
  ...
  static func ==(lhs: Com_Newsbreak_Mes_Events_AdHideEvent, rhs: Com_Newsbreak_Mes_Events_AdHideEvent) -> Bool {
