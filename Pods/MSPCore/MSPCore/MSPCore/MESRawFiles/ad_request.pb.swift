...
struct Com_Newsbreak_Mes_Events_AdRequest: @unchecked Sendable {
...
extension Com_Newsbreak_Mes_Events_AdRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Com_Newsbreak_Mes_Events_AdRequest, rhs: Com_Newsbreak_Mes_Events_AdRequest) -> Bool {
