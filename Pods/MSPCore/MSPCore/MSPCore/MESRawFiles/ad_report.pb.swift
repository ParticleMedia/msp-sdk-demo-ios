...
struct Com_Newsbreak_Mes_Events_AdReportEvent: @unchecked Sendable {
...
extension Com_Newsbreak_Mes_Events_AdReportEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AdReportEvent"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    7: .same(proto: "org"),
    8: .same(proto: "app"),
    9: .standard(proto: "msp_sdk_version"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 6: try { try decoder.decodeSingularEnumField(value: &_storage._os) }()
        case 7: try { try decoder.decodeSingularStringField(value: &_storage._org) }()
        case 8: try { try decoder.decodeSingularStringField(value: &_storage._app) }()
        case 9: try { try decoder.decodeSingularStringField(value: &_storage._mspSdkVersion) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._os != .unspecified {
        try visitor.visitSingularEnumField(value: _storage._os, fieldNumber: 6)
      }
      if !_storage._org.isEmpty {
        try visitor.visitSingularStringField(value: _storage._org, fieldNumber: 7)
      }
      if !_storage._app.isEmpty {
        try visitor.visitSingularStringField(value: _storage._app, fieldNumber: 8)
      }
      if !_storage._mspSdkVersion.isEmpty {
        try visitor.visitSingularStringField(value: _storage._mspSdkVersion, fieldNumber: 9)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Com_Newsbreak_Mes_Events_AdReportEvent, rhs: Com_Newsbreak_Mes_Events_AdReportEvent) -> Bool {
