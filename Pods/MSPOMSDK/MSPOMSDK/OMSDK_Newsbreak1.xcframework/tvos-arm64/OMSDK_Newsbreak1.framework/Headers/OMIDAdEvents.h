 ...
 */
@interface OMIDNewsbreak1AdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDNewsbreak1AdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDNewsbreak1VASTProperties *_Nonnull)vastProperties
